...
})({"5S4fD":[function(require,module,exports,__globalThis) {
...
var _foodTimesChart = require("./food-times-chart");
(0, _foodTimesChart.renderFoodTimesChart)();

},{"bootstrap/dist/css/bootstrap.min.css":"i5LP7","../css/main.css":"fvj34","./food-times-chart":"extoe"}],"i5LP7":[function() {},{}],"fvj34":[function() {},{}],"extoe":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderFoodTimesChart", ()=>renderFoodTimesChart);
var _chartJs = require("chart.js");
var _food = require("./food");
(0, _chartJs.Chart).register((0, _chartJs.LineController), (0, _chartJs.LineElement), (0, _chartJs.CategoryScale), (0, _chartJs.LinearScale), (0, _chartJs.PointElement), (0, _chartJs.Legend), (0, _chartJs.Title), (0, _chartJs.Tooltip), (0, _chartJs.SubTitle), (0, _chartJs.BarElement));
const renderFoodTimesChart = ()=>{
    // Find the element
    let chartElement = document.querySelector("#food-times-chart");
    // Format the data
    const data = {
        labels: (0, _food.getFoodTimesKeys)(),
        datasets: [
            {
                label: "How hungry I am",
                data: (0, _food.getFoodTimesValues)(),
                fill: false,
    ...
    // Create the chart
    const myChart = new (0, _chartJs.Chart)(chartElement, config);
};

},{"chart.js":"ipU8D","./food":"6SwWI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ipU8D":[function(require,module,exports,__globalThis) {
/*!
 * Chart.js v4.4.6
...
},{}],"6SwWI":[function(require,module,exports,__globalThis) {
// observe the bottom of the file.
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// this is how you make your functions and other piece available
// to other files.
parcelHelpers.export(exports, "getFoodThoughtKeys", ()=>getFoodThoughtKeys);
parcelHelpers.export(exports, "getFoodThoughtsValues", ()=>getFoodThoughtsValues);
parcelHelpers.export(exports, "getFoodTimesKeys", ()=>getFoodTimesKeys);
parcelHelpers.export(exports, "getFoodTimesValues", ()=>getFoodTimesValues);
const FOOD_TIMES = {
    '8am': 1,
    '9am': 9,
    '10am': 2,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5S4fD","1Z4Rq"], "1Z4Rq", "parcelRequire94c2")
